...
class IsrPr51Strategy : public Strategy {
public:
  IsrPr51Strategy(Forwarder& forwarder, const Name& name = getStrategyName());

  virtual ~IsrPr51Strategy() override;
...
protected:
  ...
  double sucr_diff_thrs = 0.1; //succ_ratio diff threshold
