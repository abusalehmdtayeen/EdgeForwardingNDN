...
class IsrPr4Strategy : public Strategy {
public:
  IsrPr4Strategy(Forwarder& forwarder, const Name& name = getStrategyName());

  virtual ~IsrPr4Strategy() override;
...
protected:
  ...
  double satr_diff_thrs = 0.1; //satratio diff threshold
